...
public class ClientWithoutSecurity {
		...
		try {
			...
			if (recv_nonce != nonce){
				...
				for(int i=0; i<numOfFiles; i++){
					...
					// Send the filename
					sendFilename(toServer, listOfFilenames[i]);
					//toServer.flush();
	...
	private static void sendFilename(DataOutputStream toServer, String filename) throws Exception{
		toServer.writeInt(0);
	...
	, DataOutputStream toServer) throws Exception{
